...
blacklist_enable = redir:option(Flag, "blacklist_enabled", translate("Bypass Lan IP Address"))
...
whitelist_enable = redir:option(Flag, "whitelist_enabled", translate("Bypass Server IP Address"))
