...
blacklist_enable = s:option(Flag, "blacklist_enabled", translate("Bypass Lan IP Address"))
...
whitelist_enable = s:option(Flag, "whitelist_enabled", translate("Bypass Server IP Address"))
